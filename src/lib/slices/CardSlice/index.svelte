...
<article data-slice-type={slice.slice_type} data-slice-variation={slice.variation} id="card">
...
<section class="left cover"></section>

<section class="right cover"></section>
...
.right{
    transform:translateZ(25px) translateX(279px) translateY(0px) rotateY(90deg);
}
  
.bottom{
    transform:translateZ(25px) translateX(0px) translateY(476px) rotateX(90deg);
}
